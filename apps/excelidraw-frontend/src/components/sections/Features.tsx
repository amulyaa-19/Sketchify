...
export default function Features() {
  const featuresData = [
    ...
    },
    {
      icon: Sparkles,
      title: "Smart Drawing",
      description: "Intelligent shape recognition and drawing assistance helps you create perfect diagrams with minimal effort."
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {featuresData.map((feature, index) => (
            <Card 
              key={index} 
              className="bg-gradient-to-br from-gray-800 to-gray-700 border-0 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:translate-y-[-8px] group"
              title=""
              href="/#"
            >
              <div className="p-8">
                <div className="w-14 h-14 rounded-lg bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
