            ...
            <div className="mt-10 flex items-center justify-center gap-x-6 ">
              <Link href={"/signin"}>
                <Button
                  variant={"outline"}
                  size="lg"
                  className="h-12 px-6 border-1 rounded-2xl cursor-pointer flex items-center hover:bg-gray-600 transition duration-200 ease-in-out"
                >
                  Sign in
              ...
              <Link href="/signup">
                <Button
                  variant={"outline"}
                  size="lg"
                  className="h-12 px-6 rounded-2xl cursor-pointer text-white border-1 hover:bg-gray-600 transition duration-200 ease-in-out"
                >
                  Sign up
                </Button>
              </Link>
            ...
            <div className="mx-auto max-w-2xl text-center ">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6 ">
                <Button
                  size="lg"
                  variant="secondary"
                  className="h-12 px-6 border-1 flex items-center cursor-pointer hover:bg-gray-600 transition duration-200 ease-in-out"
                >
                  Open Canvas
                  <Pencil className="ml-2 h-4 w-4" />
                </Button>
                <Button
                  variant="outline"
                  size="lg"
                  className="h-12 px-6 bg-transparent text-primary-foreground border-primary-foreground hover:bg-primary-foreground hover:text-primary cursor-pointer  hover:bg-gray-600 transition duration-200 ease-in-out"
                >
                  View Gallery
                </Button>
              </div>
